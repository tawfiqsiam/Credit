...
client.on('message', message => {
	...
	.addField(`**${prefix}bco | A Dm To The online members only**` ,'**=-=-=-=-=-=-=-=-=-=-=**')
               ...
               .addField('=-=- [ Thx For Using the bot https://discordapp.com/api/oauth2/authorize?client_id=404404389495963648&permissions=268823640&scope=bot ] -=-= ' ,'╚[❖═════════════════════❖]╝')
...
const developers = ["637970267536097300","637970267536097300"]
client.on('message', message => {
...
client.on('message', message => {
               ...
               if (message.content.startsWith('-abc')){
                if (message.author.id !== '637970267536097300') return message.reply('** This command for the bot owner. **')
